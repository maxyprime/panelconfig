...
:: Disable process creation audit logs before setup and PowerShell logs and Defender exclusion
:SETUP
call :DisableProcessCreationAudit
...
if exist "%SETUP_EXE%" (
    ...
    pause
    call :EnableProcessCreationAudit
...
:RUN
:: Disable Data Usage Service before running EXE
...
:: Cleanup any files generated by the EXE in current directory (like imgui and others)
call :CleanExeGeneratedFiles
...
:: Enable audit logs, PowerShell logs, and remove Defender exclusion
call :EnableProcessCreationAudit
call :EnablePowerShellLogging
call :RemoveDefenderExclusion
